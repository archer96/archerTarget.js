jat.Target.prototype.createArrows =  function (arrows) {
    ...
    for (i = 0; i < arrows.length; i = i + 1) {
        ...
        arrowsetClass = arrows[i].active ? '' : 'hidden';
                    
        arrows[i].element = this.canvas.createGroup(false, { id: $(this.container).attr('id') + 'ArrowSet_' + i, eleClass: 'arrowSetCanvas' + ' ' + arrowsetClass });
