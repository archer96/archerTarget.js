jat.Target.prototype.createArrows =  function (arrows) {
    ...
    self.arrowGroup = self.canvas.createGroup(false, {id: self.containerId + 'ArrowContainer' });
    ...
    for (i = 0; i < arrowLength; i++) {
        ...
        arrow.element = self.canvas.createGroup(false, { id: self.containerId + 'ArrowSet_' + i, eleClass: 'arrowSetCanvas' });
