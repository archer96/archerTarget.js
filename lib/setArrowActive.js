 ...
 * @param {Boolean} [arrow.active]   Active state of the arrow(set). If not given, we'll use the options from the arrows.
 */
    ...
    var self = this,
        ...
        setArrow = function (arrowSetID, arrowID, active) {
            ...
            if (typeof (active) === 'undefined') {
                ...
                active = self.arrow[arrowSetID].data[arrowID].active;
        ...
        setArrowset = function (arrowSetID, active) {
            ...
            for (i = 0; i < self.arrow[arrowSetID].data.length; i++) {
