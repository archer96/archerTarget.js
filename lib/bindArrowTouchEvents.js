jat.Target.prototype.bindArrowTouchEvents = function () {
    ...
    var move = function () {
        ...
        onTouchStart = function (e) {
            ...
            curPageX = touches[0].pageX - offsetLeft || self.convertTo.pxX(arrowTmp.data.x, arrowTarget);
            curPageY = touches[0].pageY - offsetTop || self.convertTo.pxY(arrowTmp.data.y, arrowTarget);
