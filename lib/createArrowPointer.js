...
jat.Target.prototype.createArrowPointer = function (config) {
    ...
    self.dragMark.element = self.canvas.createGroup(false, { id: self.containerId + 'ArrowDrag' });
    ...
    self.dragMark.element.appendChild(self.dragMark.rect);
    ...
    self.dragMark.element.appendChild(self.dragMark.circle);
    
    self.canvas.canvas.appendChild(self.dragMark.element);
};