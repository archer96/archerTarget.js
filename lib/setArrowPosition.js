 ...
 */
 jat.Target.prototype.setArrowPosition = function (arrow) {
    ...
    var i,
        j,
        self = this,
        toPxX = self.convertTo.px.x,
        toPxY = self.convertTo.px.y,
        defaultConfig = {
        ...
        setPosition = function (arrowsetID, arrowID) {
            ...
            var arrowData = self.arrow[arrowsetID].data[arrowID];

            arrowData.element.setPosition({
    ...
    if (typeof(arrow) === 'undefined') {
        ...
        DEVMODE > 8 && console.log('jAT ' + DEVNAME + ':: setArrowPosition :: positioning all arrows');
